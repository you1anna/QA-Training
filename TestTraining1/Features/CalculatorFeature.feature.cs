...
#line hidden
        ...
        [NUnit.Framework.TestCaseAttribute("10.5", "10", "20.5", null)]
        public virtual void AddTwoNumbers(string n1, string n2, string result, string[] exampleTags)
        {
...
#line 8
 testRunner.Given(string.Format("I have entered {0} and {1} into the calculator", n1, n2), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Given ");
#line 9
